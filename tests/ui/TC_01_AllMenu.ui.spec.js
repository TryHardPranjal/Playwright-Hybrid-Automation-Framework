...
test.describe('All Menu Feature', () => {
  ...
  test('Verify All Menu Sections and Items', async () => {
  ...
  // capture screenshots
  await home.captureFullPageScreenshot('all-menu-full-page');
  await home.captureElementScreenshot('all-menu-section');

  // visual comparison
  await home.compareFullPageScreenshot('all-menu-full-page');
  await home.compareMenuScreenshot('all-menu-section');
